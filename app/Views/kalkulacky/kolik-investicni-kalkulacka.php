...
<div class="mortgage-calculator">
    <div class="top">
      ...
      <form class="calculator calculator-how-invest calculator-form" id="calculator-rent" onsubmit="event.preventDefault();">
        <div class="flex">
          ...
          <div class="group">
              <label for="goal-investment"> <span>Cílová částka</span> 
  ...
  <div id="calculator-compound-interest-result" class="calculator calculator-results calculator-compound-interest-results" style="text-align:center">
      ...
      <div class="calculator-result-row"> <span class="calculator-result-row-title">Měsíční investice:</span> <b><span class="calculator-result-row-value" data-result="finalValue" data-suffix="Kč">2 361 651 Kč</span></b></div> 
