      ...
      <form class="calculator calculator-rent calculator-form" id="calculator-how-invest" onsubmit="event.preventDefault();">
        <div class="flex">
          ...
          <div class="group">
              ...
              <input id="annual-interest-rate" type="number" min="0.1" step="0.1" name="annual-interest-rate" value="<?= get_calculators()->rent ?>" data-default="<?= get_calculators()->rent ?>" > </label>
          </div>
        </div>
