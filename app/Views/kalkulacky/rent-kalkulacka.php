...
<div class="mortgage-calculator">
    <div class="top">
      ...
      <form class="calculator calculator-rent calculator-form" id="calculator-how-invest" onsubmit="event.preventDefault();">
        <div class="flex">
          <div class="group">
              <label for="start-investment"> <span>Investice pro výplatu renty</span> 
          ...
          <div class="group">
              <label for="goal-investment"> <span>Pravidelná měsíční renta</span> 
          ...
          <div class="group">
              <label for="annual-interest-rate"> <span>Výnos po dobu renty (%)</span> 
  ...
  <div id="calculator-compound-interest-result" class="calculator calculator-results calculator-compound-interest-results" style="text-align:center">
      ...
      <div class="calculator-result-row"> <span class="calculator-result-row-title">Zhodnocení:</span> <b><span class="calculator-result-row-value" data-result="investedValue" data-suffix="Kč">484 000 Kč</span></b></div>
