            ...
            <form class="calculator calculator-loan calculator-form" id="calculator-loan">
              <div class="flex">
                ...
                <div class="group">
                    ...
                    <input id="annual-interest-rate" type="number" min="0.1" step="0.1" name="annual-interest-rate" value="<?= get_calculators()->mortgage ?>" data-default="<?= get_calculators()->mortgage ?>" > </label>
                </div>
                <div class="group">
