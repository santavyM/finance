...
$user_id = $_GET['uid'];
$user_folder_path = '../../../files/media'.$user_id.'_files'; //result: media34_files,media2_files
$user_trash_folder_path = $user_folder_path.'/.trash';
if( !is_dir($user_folder_path) ){ mkdir($user_folder_path,0777,true); }
if( !is_dir($user_trash_folder_path) ){ mkdir($user_trash_folder_path,0777,true); }
$opts = array(
	// 'debug' => true,
	'roots' => array(
		// Items volume
